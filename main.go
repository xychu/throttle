...
func main() {
	...
	throttleInformerFactory := informers.NewSharedInformerFactory(throttleClient, time.Second*30)

	controller := NewController(kubeClient, throttleClient, kubeInformerFactory, throttleInformerFactory)
